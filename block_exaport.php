...
class block_exaport extends block_list {
    ...
    public function get_content() {
        ...
        $this->content->items[] = '<a title="' . block_exaport_get_string('whyEportfolio') . '" ' .
            ' href="' . $CFG->wwwroot . '/blocks/exaport/whyeportfolio.php?courseid=' . $COURSE->id . '" class="exaport-nav">' .
        ...
        $this->content->items[] = '<a title="' . block_exaport_get_string('resume_my') . '" ' .
            ' href="' . $CFG->wwwroot . '/blocks/exaport/resume.php?courseid=' . $COURSE->id . '" class="exaport-nav">' .
        ...
        $this->content->items[] = '<a title="' . block_exaport_get_string('views') . '" ' .
            ' href="' . $CFG->wwwroot . '/blocks/exaport/views_list.php?courseid=' . $COURSE->id . '" class="exaport-nav">' .
        ...
        $this->content->items[] = '<a title="' . block_exaport_get_string('shared_views') . '" ' .
            ' href="' . $CFG->wwwroot . '/blocks/exaport/shared_views.php?courseid=' . $COURSE->id . '" class="exaport-nav">' .
