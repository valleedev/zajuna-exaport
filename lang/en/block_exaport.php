...
$string['upload_file_evidence'] = 'Upload file/evidence';
$string['onlystudentscanupload'] = 'Only students can use this quick upload feature';
$string['cannotuploadhere'] = 'You cannot upload files in this folder. You can only upload in folders you have created';
