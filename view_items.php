        ...
        if ($category->id == -1) {
            ...
            if (block_exaport_instructor_has_permission('edit', $category->id)) {
                ...
                $categoryContent .= '<a href="' . $CFG->wwwroot . '/blocks/exaport/category.php?courseid=' . $courseid . '&id=' . $category->id . '&action=edit' . $evidencias_param . '">'
                    ...
                    . '<svg id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" width="15" height="15">
                        <path class="cls-1" d="M11.13,7.96c-1.22,1.13-2.36,2.57-3.61,3.64-.29.25-.56.39-.95.44-.62.09-1.5.15-2.13.17-.75.02-1.42-.37-1.4-1.2.01-.65.1-1.51.17-2.16.04-.31.09-.59.26-.86L10.35,1.05c.67-.53,1.43-.48,2.06.07.49.42,1.37,1.28,1.77,1.78.51.62.5,1.41,0,2.03-.85,1.05-2.14,2.02-3.06,3.04ZM11.31,1.6c-.1,0-.23.07-.31.13-.33.24-.66.73-1,1l2.55,2.52c.36-.48,1.48-1.03.95-1.72-.46-.6-1.28-1.17-1.77-1.77-.11-.09-.28-.16-.41-.14ZM4.03,11.22s.18.08.24.08c.63-.01,1.53-.09,2.17-.17.11-.01.24-.05.33-.11l5.08-5.07-2.5-2.57-5.1,5.11c-.11.17-.13.7-.15.93-.04.42-.09.93-.1,1.35,0,.1-.02.38.04.45Z"/>
                        <path class="cls-1" d="M2.42,2.75c.97-.11,2.11.06,3.1,0,.5.11.47.84-.03.91-.84.12-1.96-.07-2.84,0-.59.05-1.04.51-1.1,1.1v8.08c.05.65.52,1.08,1.17,1.13h7.98c1.83-.15.96-2.74,1.17-3.94.14-.48.77-.47.91,0-.09,1.84.63,4.53-1.94,4.85H2.58c-1.01-.07-1.82-.87-1.94-1.88V4.56c.12-.89.88-1.7,1.79-1.8Z"/>
                    </svg>'
                    . '</a>'
                    . '<a href="' . $delete_url . '">'
        ...
        if (in_array($type, ['mine', 'shared'])) {
            ...
            if (block_exaport_user_can_edit_item($item, $courseid)) {
                $itemContent .= '<a href="' . $CFG->wwwroot . '/blocks/exaport/item.php?courseid=' . $courseid . '&id=' . $item->id .
                    '&action=edit' . $cattype . '">'
                    . '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 15" width="15" height="15">' .
                    '<path fill="#00304d" d="M11.13,7.96c-1.22,1.13-2.36,2.57-3.61,3.64-.29.25-.56.39-.95.44-.62.09-1.5.15-2.13.17-.75.02-1.42-.37-1.4-1.2.01-.65.1-1.51.17-2.16.04-.31.09-.59.26-.86L10.35,1.05c.67-.53,1.43-.48,2.06.07.49.42,1.37,1.28,1.77,1.78.51.62.5,1.41,0,2.03-.85,1.05-2.14,2.02-3.06,3.04ZM11.31,1.6c-.1,0-.23.07-.31.13-.33.24-.66.73-1,1l2.55,2.52c.36-.48,1.48-1.03.95-1.72-.46-.6-1.28-1.17-1.77-1.77-.11-.09-.28-.16-.41-.14ZM4.03,11.22s.18.08.24.08c.63-.01,1.53-.09,2.17-.17.11-.01.24-.05.33-.11l5.08-5.07-2.5-2.57-5.1,5.11c-.11.17-.13.7-.15.93-.04.42-.09.93-.1,1.35,0,.1-.02.38.04.45Z"/>' .
                    '<path fill="#00304d" d="M2.42,2.75c.97-.11,2.11.06,3.1,0,.5.11.47.84-.03.91-.84.12-1.96-.07-2.84,0-.59.05-1.04.51-1.1,1.1v8.08c.05.65.52,1.08,1.17,1.13h7.98c1.83-.15.96-2.74,1.17-3.94.14-.48.77-.47.91,0-.09,1.84.63,4.53-1.94,4.85H2.58c-1.01-.07-1.82-.87-1.94-1.88V4.56c.12-.89.88-1.7,1.79-1.8Z"/>' .
                    '</svg>'
                    . '</a>';
            }
